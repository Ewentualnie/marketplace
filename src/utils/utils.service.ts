  ...
  async initializeLanguages() {
    if ((await this.languageRepository.count()) === 0) {
      const languageData = [
        ...
        { alpha2: 'es', languageEn: 'Spanish', languageUa: 'Іспанська' },
        { alpha2: 'pt', languageEn: 'Portuguese', languageUa: 'Португальська' },
        { alpha2: 'ru', languageEn: 'Russian', languageUa: 'Російська' },
        { alpha2: 'zh', languageEn: 'Chinese', languageUa: 'Китайська' },
        { alpha2: 'ja', languageEn: 'Japanese', languageUa: 'Японська' },
        { alpha2: 'ar', languageEn: 'Arabic', languageUa: 'Арабська' },
        { alpha2: 'ko', languageEn: 'Korean', languageUa: 'Корейська' },
        { alpha2: 'hi', languageEn: 'Hindi', languageUa: 'Гінді' },
        { alpha2: 'bn', languageEn: 'Bengali', languageUa: 'Бенгальська' },
        { alpha2: 'vi', languageEn: 'Vietnamese', languageUa: "В'єтнамська" },
        { alpha2: 'tr', languageEn: 'Turkish', languageUa: 'Турецька' },
        { alpha2: 'nl', languageEn: 'Dutch', languageUa: 'Голландська' },
        { alpha2: 'sv', languageEn: 'Swedish', languageUa: 'Шведська' },
        { alpha2: 'fi', languageEn: 'Finnish', languageUa: 'Фінська' },
        { alpha2: 'no', languageEn: 'Norwegian', languageUa: 'Норвезька' },
        { alpha2: 'da', languageEn: 'Danish', languageUa: 'Данська' },
        { alpha2: 'el', languageEn: 'Greek', languageUa: 'Грецька' },
        { alpha2: 'cs', languageEn: 'Czech', languageUa: 'Чеська' },
        { alpha2: 'hu', languageEn: 'Hungarian', languageUa: 'Угорська' },
        { alpha2: 'ro', languageEn: 'Romanian', languageUa: 'Румунська' },
        { alpha2: 'bg', languageEn: 'Bulgarian', languageUa: 'Болгарська' },
        { alpha2: 'sr', languageEn: 'Serbian', languageUa: 'Сербська' },
        { alpha2: 'hr', languageEn: 'Croatian', languageUa: 'Хорватська' },
        { alpha2: 'sk', languageEn: 'Slovak', languageUa: 'Словацька' },
      ];
