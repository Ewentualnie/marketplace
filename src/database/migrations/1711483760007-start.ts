...
export class Start1711483760007 implements MigrationInterface {
    name = 'Start1711483760007'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "mail" ("id" SERIAL NOT NULL, "message" character varying NOT NULL, "writtedAt" TIMESTAMP NOT NULL DEFAULT now(), "isReaded" boolean NOT NULL DEFAULT false, "toUserId" integer, "fromUserId" integer, CONSTRAINT "PK_5407da42b983ba54c6c62d462d3" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "user" ("id" SERIAL NOT NULL, "email" character varying NOT NULL, "hashedPass" character varying NOT NULL, "firstName" character varying NOT NULL, "lastName" character varying, "role" character varying NOT NULL DEFAULT 'user', "isDeleted" boolean NOT NULL DEFAULT false, "lastVisit" TIMESTAMP NOT NULL DEFAULT now(), "registeredAt" TIMESTAMP NOT NULL DEFAULT now(), "rating" double precision NOT NULL DEFAULT '5', "birthday" TIMESTAMP, "sex" character varying, "photo" character varying, "refreshToken" character varying, "aboutMe" character varying, "country" integer, "advertId" integer, CONSTRAINT "UQ_e12875dfb3b1d92d7d7c5377e22" UNIQUE ("email"), CONSTRAINT "REL_b78cd9491419afdda263fffdea" UNIQUE ("advertId"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
