...
export class First1698871149170 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "feedback" ("id" SERIAL NOT NULL, "mark" integer NOT NULL, "message" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "toUserId" integer, CONSTRAINT "CHK_1bd95bab7451631ad8a0071a95" CHECK (mark >= 1 AND mark <= 5), CONSTRAINT "PK_8389f9e087a57689cd5be8b2b13" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "hobby" ("id" SERIAL NOT NULL, "hobby" character varying NOT NULL, CONSTRAINT "UQ_bcd0682a348fea58e8dba25fb81" UNIQUE ("hobby"), CONSTRAINT "PK_9cf21d5206ec584a4cc14a8703e" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "advert" ("id" SERIAL NOT NULL, "price" numeric NOT NULL, "description" character varying NOT NULL, "imagePath" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "isDeleted" boolean NOT NULL DEFAULT false, "userId" integer, CONSTRAINT "REL_2a3714047a0c902fd9d5077fdc" UNIQUE ("userId"), CONSTRAINT "PK_4bd8b4cdfb562b02706beece450" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "user_feedback" ("feedbackId" integer NOT NULL, "userId" integer NOT NULL, CONSTRAINT "PK_2346822913546ce54eafa393e1c" PRIMARY KEY ("feedbackId", "userId"))`);
        await queryRunner.query(`CREATE INDEX "IDX_25462eeffae3a9d782a90bc59c" ON "user_feedback" ("feedbackId") `);
        await queryRunner.query(`CREATE INDEX "IDX_e4cc25c220dea064df29485e39" ON "user_feedback" ("userId") `);
        await queryRunner.query(`CREATE TABLE "users_hobby" ("hobbyId" integer NOT NULL, "userId" integer NOT NULL, CONSTRAINT "PK_a5b131e9615cf0ebb3478867c32" PRIMARY KEY ("hobbyId", "userId"))`);
        await queryRunner.query(`CREATE INDEX "IDX_c354d32dac14aacb411041332f" ON "users_hobby" ("hobbyId") `);
        await queryRunner.query(`CREATE INDEX "IDX_7e9678712c495eb0dca199e543" ON "users_hobby" ("userId") `);
        await queryRunner.query(`CREATE TABLE "user_hobbies" ("userId" integer NOT NULL, "hobbyId" integer NOT NULL, CONSTRAINT "PK_eb613c25d25ed909ae1022f3cb1" PRIMARY KEY ("userId", "hobbyId"))`);
        await queryRunner.query(`CREATE INDEX "IDX_89d557429118dbb0e6f75aa946" ON "user_hobbies" ("userId") `);
        await queryRunner.query(`CREATE INDEX "IDX_c17b94df9150e17763e80eb47d" ON "user_hobbies" ("hobbyId") `);
        ...
        await queryRunner.query(`ALTER TABLE "users_hobby" ADD CONSTRAINT "FK_c354d32dac14aacb411041332fc" FOREIGN KEY ("hobbyId") REFERENCES "hobby"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "users_hobby" ADD CONSTRAINT "FK_7e9678712c495eb0dca199e5431" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "user_hobbies" ADD CONSTRAINT "FK_89d557429118dbb0e6f75aa9469" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "user_hobbies" ADD CONSTRAINT "FK_c17b94df9150e17763e80eb47dc" FOREIGN KEY ("hobbyId") REFERENCES "hobby"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "user_hobbies" DROP CONSTRAINT "FK_c17b94df9150e17763e80eb47dc"`);
        await queryRunner.query(`ALTER TABLE "user_hobbies" DROP CONSTRAINT "FK_89d557429118dbb0e6f75aa9469"`);
        await queryRunner.query(`ALTER TABLE "users_hobby" DROP CONSTRAINT "FK_7e9678712c495eb0dca199e5431"`);
        await queryRunner.query(`ALTER TABLE "users_hobby" DROP CONSTRAINT "FK_c354d32dac14aacb411041332fc"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_c17b94df9150e17763e80eb47d"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_89d557429118dbb0e6f75aa946"`);
        await queryRunner.query(`DROP TABLE "user_hobbies"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_7e9678712c495eb0dca199e543"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_c354d32dac14aacb411041332f"`);
        await queryRunner.query(`DROP TABLE "users_hobby"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_e4cc25c220dea064df29485e39"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_25462eeffae3a9d782a90bc59c"`);
