...
export class CreateBase1698650131819 implements MigrationInterface {
  name = 'CreateBase1698650131819';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "user" ("id" SERIAL NOT NULL, "email" character varying NOT NULL, "hashedPass" character varying NOT NULL, "name" character varying NOT NULL, "role" character varying NOT NULL DEFAULT 'user', "isDeleted" boolean NOT NULL DEFAULT false, "refreshToken" character varying, "advertId" integer, CONSTRAINT "UQ_e12875dfb3b1d92d7d7c5377e22" UNIQUE ("email"), CONSTRAINT "REL_b78cd9491419afdda263fffdea" UNIQUE ("advertId"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "advert" ("id" SERIAL NOT NULL, "price" numeric NOT NULL, "shortDescription" character varying NOT NULL, "imagePath" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "isDeleted" boolean NOT NULL DEFAULT false, "userId" integer, CONSTRAINT "REL_2a3714047a0c902fd9d5077fdc" UNIQUE ("userId"), CONSTRAINT "PK_4bd8b4cdfb562b02706beece450" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "advert_hobbies_hobby" ("advertId" integer NOT NULL, "hobbyId" integer NOT NULL, CONSTRAINT "PK_87aa98c1bb114e38944f4282d42" PRIMARY KEY ("advertId", "hobbyId"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_342d356670985876d46ebc5ca6" ON "advert_hobbies_hobby" ("advertId") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_f5613b7b7ff0ed6850e6f68d98" ON "advert_hobbies_hobby" ("hobbyId") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "advert_hobbies_hobby" ADD CONSTRAINT "FK_342d356670985876d46ebc5ca6d" FOREIGN KEY ("advertId") REFERENCES "advert"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "advert_hobbies_hobby" ADD CONSTRAINT "FK_f5613b7b7ff0ed6850e6f68d98f" FOREIGN KEY ("hobbyId") REFERENCES "hobby"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "advert_hobbies_hobby" DROP CONSTRAINT "FK_f5613b7b7ff0ed6850e6f68d98f"`,
    );
    await queryRunner.query(
      `ALTER TABLE "advert_hobbies_hobby" DROP CONSTRAINT "FK_342d356670985876d46ebc5ca6d"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_f5613b7b7ff0ed6850e6f68d98"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_342d356670985876d46ebc5ca6"`,
    );
    await queryRunner.query(`DROP TABLE "advert_hobbies_hobby"`);
    await queryRunner.query(
